  ...
  return (
    ...
    >
        ...
        <div className="relative h-[calc(100vh-100px)] w-full flex justify-center">
          ...
          <div className="absolute inset-x-0 bottom-6 z-10 flex justify-center">
            <div className="relative w-full md:w-3/4 bg-white/10 backdrop-blur-sm shadow-lg rounded-xl px-4 py-10 text-center outer-box">
              <h1 className="font-space drop-shadow-xl hero-gradient text-4xl font-semibold mb-2">
                {`<h1>Shayok</h1>`}
              </h1>
              <h1 className="font-space hero-gradient text-4xl font-semibold">
                Front End Developer
              </h1>
            </div>
          </div>
      ...
      <div className="hidden lg:flex container mx-auto h-full items-center">
        <div className="outer-box w-6/12 text-center flex justify-center border-t-r py-16">
          <div className="inner-box h-full w-full flex flex-col justify-center">
            <div className="max-sm:py-10 text-4xl font-semibold lg:text-5xl py-32">
              <h1 className="font-space drop-shadow-xl hero-gradient mb-2">
                {`<h1>Shayok</h1>`}
              </h1>
